export const addedSanrioProps = {
    ...
    badtzMaru: {
        ...
        longDesc:
            ...
            `and usually roots for the bad side of things. He can be self-centered as his greatist desire is to "become`
            `the boss, of everthing" and he enjoys gathering images of "bad guys" from films. Badtz is a black penguin`
            `with spiky hair whose home is in Gorgeous Town along with his parents and siblings.`,
        realName: "Badtz-Maru",
    },
    kuromi: {
